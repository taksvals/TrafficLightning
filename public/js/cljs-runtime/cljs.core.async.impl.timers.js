...
var i_45991 = (0);
while(true){
if((i_45991 < arr.length)){
(arr[i_45991] = null);

var G__45992 = (i_45991 + (1));
i_45991 = G__45992;
continue;
} else {
}
...
var i_46000 = (self__.level + (1));
while(true){
if((i_46000 <= (new_level + (1)))){
(update[i_46000] = self__.header);

var G__46001 = (i_46000 + (1));
i_46000 = G__46001;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46002 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46002[i]));
} else {
x__$2.forward.push((((i < links_46002.length))?(links_46002[i]):null));
}

if((i < links_46002.length)){
(links_46002[i] = x__$2);
} else {
links_46002.push(x__$2);
}
...
var i_46006 = (0);
while(true){
if((i_46006 <= self__.level)){
var links_46007 = (update[i_46006]).forward;
if((x__$1 === (((i_46006 < links_46007.length))?(links_46007[i_46006]):null))){
(links_46007[i_46006] = (x__$1.forward[i_46006]));

var G__46008 = (i_46006 + (1));
i_46006 = G__46008;
continue;
} else {
var G__46009 = (i_46006 + (1));
i_46006 = G__46009;
continue;
}
} else {
...
var G__46012 = nx;
var G__46013 = (level__$1 - (1));
x = G__46012;
level__$1 = G__46013;
continue;
} else {
var G__46014 = x;
var G__46015 = (level__$1 - (1));
x = G__46014;
level__$1 = G__46015;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46017 = nx;
var G__46018 = (level__$1 - (1));
x = G__46017;
level__$1 = G__46018;
continue;
} else {
var G__46019 = x;
var G__46020 = (level__$1 - (1));
x = G__46019;
level__$1 = G__46020;
continue;
}
