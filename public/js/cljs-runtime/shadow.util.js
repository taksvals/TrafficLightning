...
var len__4829__auto___50025 = arguments.length;
var i__4830__auto___50026 = (0);
while(true){
if((i__4830__auto___50026 < len__4829__auto___50025)){
args_arr__4850__auto__.push((arguments[i__4830__auto___50026]));

var G__50027 = (i__4830__auto___50026 + (1));
i__4830__auto___50026 = G__50027;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq49908){
...
var G__49911 = cljs.core.first(seq49908__$2);
var seq49908__$3 = cljs.core.next(seq49908__$2);
var G__49913 = cljs.core.first(seq49908__$3);
var seq49908__$4 = cljs.core.next(seq49908__$3);
var G__49915 = cljs.core.first(seq49908__$4);
var seq49908__$5 = cljs.core.next(seq49908__$4);
var G__49916 = cljs.core.first(seq49908__$5);
var seq49908__$6 = cljs.core.next(seq49908__$5);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49909,G__49910,G__49911,G__49913,G__49915,G__49916,seq49908__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__49998){
var vec__49999 = p__49998;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49999,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49999,(1),null);
