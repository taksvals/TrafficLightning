...
var G__56193 = o;
goog.object.set(G__56193,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__56218__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__56218 = function (var_args){
var args = null;
...
return G__56218__delegate.call(this,args);};
G__56218.cljs$lang$maxFixedArity = 0;
G__56218.cljs$lang$applyTo = (function (arglist__56220){
var args = cljs.core.seq(arglist__56220);
return G__56218__delegate(args);
});
G__56218.cljs$core$IFn$_invoke$arity$variadic = G__56218__delegate;
return G__56218;
})()
;
} else {
...
var G__56196 = o;
goog.object.set(G__56196,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__56221__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__56221 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56222__i = 0, G__56222__a = new Array(arguments.length -  0);
while (G__56222__i < G__56222__a.length) {G__56222__a[G__56222__i] = arguments[G__56222__i + 0]; ++G__56222__i;}
  args = new cljs.core.IndexedSeq(G__56222__a,0,null);
} 
return G__56221__delegate.call(this,args);};
G__56221.cljs$lang$maxFixedArity = 0;
G__56221.cljs$lang$applyTo = (function (arglist__56223){
var args = cljs.core.seq(arglist__56223);
return G__56221__delegate(args);
});
G__56221.cljs$core$IFn$_invoke$arity$variadic = G__56221__delegate;
return G__56221;
})()
;
} else {
...
var G__56197 = props;
var G__56197__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56197,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__56197);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56197__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__56197__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__56198 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56198,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__56198;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__56199){
var map__56200 = p__56199;
var map__56200__$1 = cljs.core.__destructure_map(map__56200);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56200__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__56201_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__56201_SHARP_);
}));
} else {
return null;
}
...
var vec__56203 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56203,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56203,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56203,(2),null);
...
var temp__5757__auto___56231 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___56231 == null)){
} else {
var key_56232 = temp__5757__auto___56231;
(jsprops.key = key_56232);
}
...
var temp__5757__auto___56233 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___56233 == null)){
} else {
var key_56234 = temp__5757__auto___56233;
(jsprops.key = key_56234);
}
...
var G__56207 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__56207) : reagent.impl.template.as_element.call(null,G__56207));
} else {
var temp__5757__auto___56239 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___56239 == null)){
} else {
var key_56240 = temp__5757__auto___56239;
(jsprops.key = key_56240);
}
...
var G__56209 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__56209)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56209)){
return x;
} else {
...
var len__4829__auto___56241 = arguments.length;
var i__4830__auto___56242 = (0);
while(true){
if((i__4830__auto___56242 < len__4829__auto___56241)){
args__4835__auto__.push((arguments[i__4830__auto___56242]));

var G__56243 = (i__4830__auto___56242 + (1));
i__4830__auto___56242 = G__56243;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq56210){
var G__56211 = cljs.core.first(seq56210);
var seq56210__$1 = cljs.core.next(seq56210);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56211,seq56210__$1);
}));
...
break;
default:
var G__56245 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__56245;
continue;
...
var ctx = ({});
var vec__56214 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56214,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56214,(1),null);
...
var G__56217 = (cljs.core.count(argv) - first_child);
switch (G__56217) {
case (0):
